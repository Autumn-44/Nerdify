            ...
            <div className='space-y-5'>
              ...
              <div>
                ...
                <input
                  ...
                  className='w-full bg-white/5 border border-white/10 rounded-lg px-4 py-2.5 text-white focus:border-orange-400/50 focus:ring-1 focus:ring-orange-400/20 outline-none transition-all'
                />
              </div>
