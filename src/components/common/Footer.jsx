    ...
    <footer className='mt-20 border-t' style={{ borderColor: 'rgba(255,255,255,0.06)', background: '#0a0e14' }}>
      <div className='max-w-[1400px] mx-auto px-6 md:px-10 py-10 flex flex-col md:flex-row items-center justify-between gap-6'>
        <Link to='/' className='flex items-center gap-3 group'>
          <span className='flex items-center justify-center h-9 w-9 bg-black rounded-full overflow-hidden opacity-85 group-hover:opacity-100 transition-opacity'>
        ...
        <div className='flex items-center gap-4 sm:gap-6 text-xs flex-wrap justify-center' style={{ color: '#8b949e' }}>
